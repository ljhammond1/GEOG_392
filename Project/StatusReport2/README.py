 # pip install opencv-python, sklearn, scipy (also need pip install pillow, as imread has pil dependencies in python 3, if using pip)
 # could also use anaconda if you want
import cv2
import numpy as np
...
def find_PCAKmeans(imagepath1, imagepath2):
    ...
    imagepath1 = r'P:\\GISProgramming\\Corpus_12-06-17.jpg'
    imagepath2 = r'P:\\GISProgramming\\Corpus_11-23-17.jpg'
